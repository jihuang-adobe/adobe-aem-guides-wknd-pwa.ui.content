const { REACT_APP_SITE, REACT_APP_CONTENT_PATH } = process.env;

let defaultSite = REACT_APP_SITE;
let defaultContentPath = `/content/${REACT_APP_SITE}${REACT_APP_CONTENT_PATH}`;
